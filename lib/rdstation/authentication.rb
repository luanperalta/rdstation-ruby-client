...
module RDStation
  class Authentication
    ...
    def initialize(client_id = nil, client_secret = nil)
      ...
      @client_id = client_id || (RDStation.configuration.nil? ? nil : RDStation.configuration.client_id)
      @client_secret = client_secret || (RDStation.configuration.nil? ? nil : RDStation.configuration.client_secret)
    end
